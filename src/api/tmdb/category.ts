...
async function getData(
    ...
    const url = `https://api.themoviedb.org/3/discover/${param.type}?api_key=5417af578f487448df0d4932bc0cc1a5&language=pt-BR&with_genres=${param.genreId}&sort_by=popularity.desc&page=`;
